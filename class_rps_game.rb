...
until player_choice == "quit"
    ...
    if player_choice == comp_answer
        puts "Tie!"
    elsif player_choice == "rock" && comp_choices[2]
        puts "Your rock crushes my scissors. You win!"
        player_score += 1
    elsif player_choice == "rock" && comp_answer == comp_choices[1]
        puts "My paper covers your rock. I win!"
        comp_score += 1
    elsif player_choice == "paper" && comp_answer == comp_choices[0]
        puts "Your paper covers my rock. You win!"
        player_score += 1
    elsif player_choice == "paper" && comp_answer == comp_choices[2]
        puts "My scissors cuts your paper. I win!"
        comp_score += 1
    elsif player_choice == "scissors" && comp_answer == comp_choices[1]
        puts "Your scissors cuts my paper. You win!"
        player_score += 1
    elsif player_choice == "scissors" && comp_answer == comp_choices[0]
